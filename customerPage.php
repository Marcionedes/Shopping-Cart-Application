...
<script src="http://code.jquery.com/mobile/1.4.4/jquery.mobile-1.4.4.js"></script>   
    ...
    <body>
        <div id="customerPage" data-role="page">   
            ...
            ?> 
            <a href="productsPage.php"     data-ajax=false class="ui-btn" > Products</a>
            <a href="viewcartPage.php"     data-ajax=false class="ui-btn" > View Cart</a>
